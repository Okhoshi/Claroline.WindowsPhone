...
namespace ClarolineApp
{
    public class ClaroClient : INotifyPropertyChanged
    {
        ...
        public async Task<string> MakeOperationAsync(SupportedModules module, SupportedMethods method, string reqCours = null, string resStr = "", string genMod = "", bool forAuth = false)
        {
            _lastException = null;
