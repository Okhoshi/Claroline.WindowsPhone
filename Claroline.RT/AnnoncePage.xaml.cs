...
namespace ClarolineApp.RT
{
    ...
    /// </summary>
    public sealed partial class AnnoncePage : ClarolineApp.RT.Common.LayoutAwarePage
    {
        public AnnoncePage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            Annonce annonce = (Annonce) navigationParameter;
            this.DefaultViewModel["Group"] = annonce.Group;
            this.DefaultViewModel["Items"] = annonce.Group.Items;
            this.flipView.SelectedItem = annonce;
        }
        ...
        {
            var selectedItem = (Annonce)this.flipView.SelectedItem;
